...
public class ItemAmuletJusticeEye extends Item implements IBauble {

	public static final Item RING = null;

	public ItemAmuletJusticeEye(String name) {
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (player.ticksExisted % 19 == 0) {
			...
			AxisAlignedBB box = new AxisAlignedBB(center.x, center.y, center.z, center.x, center.y, center.z).grow(13);
			for (EntityLivingBase entity : player.world.getEntitiesWithinAABB(EntityLivingBase.class, box,
				...
				if (entity instanceof EntityParasiteBase) {
					entity.addPotionEffect(new PotionEffect(WAPotions.JUDGEMENT, 200, 1, false, true));
				}
			}
		}
	}
