...
public class ItemAmuletJustice extends Item implements IBauble {

	public static final Item RING = null;

	public ItemAmuletJustice(String name) {
		...
		if (player.ticksExisted % 19 == 0) {
			...
			for (EntityLivingBase entity : player.world.getEntitiesWithinAABB(EntityLivingBase.class, box,
				...
				if (entity instanceof EntityParasiteBase) {
					entity.addPotionEffect(new PotionEffect(WAPotions.JUDGEMENT, 200, 0, false, true));
					entity.addPotionEffect(new PotionEffect(MobEffects.SLOWNESS, 200, 0, false, true));
				}
			}
		}
	}
