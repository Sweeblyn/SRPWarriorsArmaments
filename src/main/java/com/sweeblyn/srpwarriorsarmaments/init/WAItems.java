...
public class WAItems {
    ...
    public static final Item semi_organic_helmet = (Item)new ItemSemiOrganicArmor("semi_organic_helmet", WAToolMaterials.SEMI_ORGANIC_ARMOR, EntityEquipmentSlot.HEAD);
